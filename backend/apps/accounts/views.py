...
class CurrentUserView(APIView):
    def get(self, request):
        ...
        setup_map = {
            str(progress.organization_id): progress
            for progress in OrganizationSetupProgress.objects.filter(
            ...
            'memberships': [
                {
                    ...
                    'setup_completed': setup_map.get(str(membership.organization_id)).setup_completed
                    if setup_map.get(str(membership.organization_id))
                    else False,
                }
