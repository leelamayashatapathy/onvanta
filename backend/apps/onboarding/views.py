...
from apps.onboarding.services import OnboardingService, OnboardingTemplateService
...
class OnboardingTemplateRequirementListCreateView(OrganizationContextMixin, APIView):
    ...
    def patch(self, request, template_id):
        ...
        for item in updates:
            ...
            payload = {key: value for key, value in serializer.validated_data.items() if key != 'id'}
